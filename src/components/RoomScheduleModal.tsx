...
import { generateRoomSchedulePDF } from '@/utils/roomSchedulePdf';
...
export function RoomScheduleModal({
  ...
  const fetchRooms = async () => {
    ...
    try {
    const res = await fetch(`${ADMIN_API_URL}/rooms`);
  ...
  return (
    <section className="schedule-page-panel">
      <div className="grid gap-5 min-w-0">
        ...
        {directoryError && <p role="alert">Could not load the directory. <Button variant="outline" onClick={fetchRooms}>Retry</Button></p>}
        <div>
          <div className="flex items-center justify-between w-full">
            <h2 className="text-xl font-bold">Classroom Schedule</h2>
